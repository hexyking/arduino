...
<?php
   ...
   // IMPORTANT: If you are using XAMPP you will have to enter your computer IP address here, if you are using webpage enter webpage address (ie. "www.yourwebpage.com")
    $con=mysqli_connect("sql208.epizy.com","epiz_23896577","yKTvF6eTqpi","epiz_23896577_sensordata");
       
    // Retrieve all records and display them   
    $result = mysqli_query($con,'SELECT * FROM epiz_23896577_sensordata.lightsensor ORDER BY id DESC');
